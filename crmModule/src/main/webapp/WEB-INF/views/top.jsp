...
<jsp:include page="common2.jsp"></jsp:include>
</head>
<body>
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
        <img src="${path}/Images/ecshop_logo.gif" alt="ECSHOP - power for e-commerce" />
    </div>
    <div id="submenu-div">
        <div id="send_info">
            <font color="white">欢迎<s:property value="#session.user_info.name"/>登录系统</font>
...
<div id="menu-div">
    <ul>
        ...
        <li><a href="${path}/main.action" target="main-frame">起始页</a></li>
        <li><a href="${path}/customer_list.action" target="main-frame">客户列表</a></li>
        <li><a href="${path}/dept_list.action" target="main-frame">员工列表</a></li>
